...
const Blog = () => {
    return (
        <Container>
            <h2 className='text-center title red-color'>Blog</h2>
            <div className='blog'>
                <h4 className='red-color'>What is cors?</h4>
            ...
            <div className='blog'>
                <h4 className='red-color'>Why are you using firebase? What other options do you have to implement authentication?</h4>
            ...
            <div className='blog'>
                <h4 className='red-color'>How does the private route work?</h4>
            ...
            <div className='blog mb-5'>
                <h4 className='red-color'>What is Node? How does Node work?</h4>
